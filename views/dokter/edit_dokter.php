        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <div class="card shadow mb-4 mt-5">
              ...
              <div class="card-body">
                <form action="../../process/dokter/update_dokter.php" method="post">
                  <div class="form-group">
                  <input type="hidden" class="form-control" id="id_dokter" name="id_dokter" value="<?php echo $row['id_dokter']; ?>" required readonly>
                  </div>
                  <div class="form-group">
                    <label for="nama">Nama Dokter</label>
                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $row['nama_dokter']; ?>" required>
                  </div>
                  <div class="form-group">
